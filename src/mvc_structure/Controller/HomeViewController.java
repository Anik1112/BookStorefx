...
public class HomeViewController implements Initializable {
    ...
    void viewAsCustomer(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/mvc_structure/View/CustomerView.fxml"));
    ...
    void viewAsBookkeeper(ActionEvent e) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/mvc_structure/View/LoginView.fxml"));
        Parent root = loader.load();
