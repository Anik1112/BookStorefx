...
public class LoginViewController {
    ...
    void loginBtn(ActionEvent e) throws IOException {
        if(username.getText().equals("Anik") && password.getText().equals("Password")) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/mvc_structure/View/BookkeeperView.fxml"));
            Parent root = loader.load();
